...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">პარტნიოტირი</h1>
            <div class="col-md-12">
                <ol class="breadcrumb">
                    <li>
                        <a href="{{route('admin.partner.show')}}"><i class="fa fa-dashboard"></i> პარტნიორი</a>
                    </li>
                    <li class="active">
                        <i class="fa fa-pencil-square-o"></i> დამატება (300 x 85)
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="form-group"><br/>
                        <div class="row">
                            <div class="col-xs-6 col-md-3">
                                <a href="{{url()}}/uploads/partner/{{$obj->image}}" class="thumbnail">
                                    <img src="{{url()}}/uploads/partner/{{$obj->image}}">
                                </a>
                            </div>
                        </div>
                    </div>
