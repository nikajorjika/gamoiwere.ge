...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-md-2">
                <a href="{{route('admin.slider.add')}}"> <button class="btn btn-default" style="width: 100%"> <i style="float: left; font-size: 22px;" class="fa fa-plus"></i> დამატება</button></a>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        @foreach($slider as $s)
                            <tr>
                                <td>{{$s->id}}</td>
                                <td><img src="{{url()}}/uploads/slider/{{$s->image}}" style="height:35px;"/></td>
                                <td>{{$s->title_geo}}</td>
                                <td>
